...
public class FenetreTIM extends JFrame implements Objet {// cf interface Objet
    ...
    public FenetreTIM()  {
        ...
        this.fi = new File(this.getClass().getClassLoader().getResource("data/sprites.png").toString().substring(5));
        try {
        ...
        try {
            ...
            AudioInputStream audioIn = AudioSystem.getAudioInputStream(new File(Optional.ofNullable(this.getClass().getClassLoader().getResource("data/alp.wav")).map(url -> url.toString().substring(5)).orElse("")));
    ...
    int lvlMaxSearch() {
        ...
        while (bo) {
            try {
                lvlM++;
                Scanner sc = new Scanner(new File(this.getClass().getClassLoader().getResource("data/lvl" + lvlM + ".txt").toString().substring(5)));
                sc.close();
    ...
    public void setterxfix(float coef, Objet o, int sign) {
        ...
        if (o instanceof Ballon) {
            ...
            if (Math.abs(o.getVy()) > 100) {
                float coefRetro = Math.max(0, Math.min((100 / norme(o.getVx(), o.getVy())) * 0.8f, 0.8f));
    ...
    public void startJeu() {// M�thode principale du thread JFrame appell�e en
        // fin de constructeur:
        ...
        tuto.setIcon(new ImageIcon(this.getClass().getClassLoader().getResource("data/tuto1.png").toString().substring(5)));
        ...
        win.setIcon(new ImageIcon(this.getClass().getClassLoader().getResource("data/youwin.png").toString().substring(5)));
        win.setLocation(0, 0);
        ...
        go.setSize(50, 50);
        go.setIcon(new ImageIcon(this.getClass().getClassLoader().getResource("data/go.png").toString().substring(5)));
        ...
        sol.setSize(50, 50);
        sol.setIcon(new ImageIcon(this.getClass().getClassLoader().getResource("data/solution.png").toString().substring(5)));
        ...
        ld.setSize(50, 50);
        ld.setIcon(new ImageIcon(this.getClass().getClassLoader().getResource("data/lvldown.png").toString().substring(5)));
        ...
        lu.setSize(50, 50);
        lu.setIcon(new ImageIcon(this.getClass().getClassLoader().getResource("data/lvlup.png").toString().substring(5)));
        ...
        saveB.setSize(50, 50);
        saveB.setIcon(new ImageIcon(this.getClass().getClassLoader().getResource("data/save.png").toString().substring(5)));
        ...
        importB.setIcon(new ImageIcon(this.getClass().getClassLoader().getResource("data/import.png").toString().substring(5)));
        ...
        stop.setSize(50, 50);
        stop.setIcon(new ImageIcon(this.getClass().getClassLoader().getResource("data/stop.png").toString().substring(5)));
        ...
        modif.setSize(50, 50);
        modif.setIcon(new ImageIcon(this.getClass().getClassLoader().getResource("data/modif.png").toString().substring(5)));
        ...
        tuto.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent e) {
                if (tutoInt == 0) {
                    tutoInt = 1;
                    tuto.setIcon(new ImageIcon(this.getClass().getClassLoader().getResource("data/tuto2.png").toString().substring(5)));
        ...
        importB.addMouseListener(new MouseAdapter() {
                                     public void mousePressed(MouseEvent e) {
                                         ...
                                         if (!isRunning) {
                                             int i = 0;
                                             try {
                                                 Scanner sc = new Scanner(new File(this.getClass().getClassLoader().getResource("data/" + entry.getText() + ".txt").toString().substring(5)));
        ...
        while (b) {
            ...
            Thread.yield(); // lache sa priorit� comme toutes les autres threads
            // apr�s un tour de boucle;
        }
    ...
    public void saveToFile(String fileName, boolean estSol) {
        ...
        if (!isRunning) {
            ...
            if (bool || (!(fileName.charAt(0) == 'l' && fileName.charAt(1) == 'v' && fileName.charAt(2) == 'l')
                ...
                try {
                    Files.write(Paths.get(this.getClass().getClassLoader().getResource("data/" + fileName + ".txt").toString().substring(5)), res.getBytes());
    ...
    public void importFromFile(String fileName) {
        ...
        String content = "";
        try {
            Scanner sc = new Scanner(new File(this.getClass().getClassLoader().getResource("data/" + fileName + ".txt").toString().substring(5)));

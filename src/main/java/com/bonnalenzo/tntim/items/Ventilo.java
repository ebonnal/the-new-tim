...
import com.bonnalenzo.tntim.threads.ThreadVentilo;
    ...
    public Vector accelModif(Objet o) {
        if (o instanceof Ballon) {
            ...
            if (Math.pow(x1 - x2, 2) + Math.pow(y1 - y2, 2) < Math.pow((getH() / 2 + o.getH() / 2), 2)) {
                ...
                float temp = 1000 * (getH() / 2 + o.getH() / 2 - Utils.norme(x1 - x2, y1 - y2));
            ...
            if (etat == 0) {
                if (Math.abs(y1 - y2) < getH() && x2 > x1) {
                    return new Vector(2 * (700 - (x2 - x1)), 0);
                }
            } else if (etat == 2) {
                if (Math.abs(y1 - y2) < getH() && x2 < x1) {
                    return new Vector(-2 * (700 + (x2 - x1)), 0);
                ...
                if (Math.abs(x1 - x2) < getH() && y2 < y1) {
                    return new Vector(0, -2 * (700 + (y2 - y1)));
                }
            } else if (etat == 3) {
                if (Math.abs(x1 - x2) < getH() && y2 > y1) {
                    return new Vector(0, 2 * (700 - (y2 - y1)));
        ...
        if (o instanceof Ventilo) {
            ...
            if (Math.pow(x1 - x2, 2) + Math.pow(y1 - y2, 2) < Math.pow((getH()), 2)) {
                ...
                o.setVx(0.95f * o.getVx());
                o.setVy(0.95f * o.getVy());
                float temp = 1000 * (getH() - Utils.norme(x1 - x2, y1 - y2));
                return new Vector(temp * normx, temp * normy);
            }
